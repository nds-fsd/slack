...
//Cogemos todos los chats del usuario de la ruta definida para ese propósito
  ...
  return (
    ...
    <div className={styles.chatContainer}>
      ...
      <ListGroup className={styles.listChats} as="ol" numbered>
       ...
       {userNames && userNames.map((e)=>{
          ...
          if(e.toString() === userNameActual){
            return (<ListGroup.Item className={styles.elementChat} variant = 'Dark' key={uniqueKey}>{e} : tú </ListGroup.Item>)
          }else{
            return (<ListGroup.Item className={styles.elementChat} variant = 'Dark' key={uniqueKey}>{e}</ListGroup.Item>)
          }
      })}
