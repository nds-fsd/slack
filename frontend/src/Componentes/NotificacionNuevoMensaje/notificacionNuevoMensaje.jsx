    ...
    return (
        ...
        <div className={styles.ContenedorNotificacionNuevoMensaje}>
            ...
            <div className={styles.mensaje}>
                ...
                <div>
                    <p className={styles.NotificacionNuevoMensaje}>Nuevo mensaje de {props.infoNotification.userName} <br /> <span>{props.infoNotification.text}</span> <br /> en el chat {props.infoNotification.chatName}</p>
                </div>
            </div>
        </div>
